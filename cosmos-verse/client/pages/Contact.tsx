      ...
      <header className="fixed top-0 w-full bg-white/98 backdrop-blur-md border-b border-gray-200/50 z-50 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/contact" className="text-green-600 font-semibold cursor-leaf">Contact</Link>
          </nav>
      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1 cursor-leaf border-2 focus:border-green-500 rounded-xl"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  <Label htmlFor="organization" className="text-sm font-medium text-gray-700">Organisation</Label>
                  <Input
                    id="organization"
                    name="organization"
                    type="text"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={6}
                    className="mt-1 cursor-leaf border-2 focus:border-green-500 rounded-xl resize-none"
                    required
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-green-600 hover:bg-green-700 cursor-leaf py-4 text-lg font-bold text-white rounded-xl fluorescent-glow transition-all duration-300 transform hover:scale-105 shadow-xl"
                >
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@collectam.cm</p>
                    <p className="text-gray-600">support@collectam.cm</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+237 2 XX XX XX XX</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-6">Collectam en chiffres</h3>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-black mb-2">500+</div>
                  <div className="text-green-100 text-sm">Villes connectées</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black mb-2">24h</div>
                  <div className="text-green-100 text-sm">Temps de réponse</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black mb-2">95%</div>
                  <div className="text-green-100 text-sm">Satisfaction client</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-black mb-2">10k+</div>
                  <div className="text-green-100 text-sm">Collectes/mois</div>
                </div>
              </div>
            </div>
          </div>
            ...
            {faqData.map((faq, index) => (
              <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 overflow-hidden">
                <button
                  ...
                  className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-gray-50 transition-colors cursor-leaf"
                >
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl p-12 text-white">
            <h2 className="text-4xl font-bold mb-6">Prêt à transformer votre gestion des déchets ?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/signup">
                <Button size="lg" variant="secondary" className="cursor-leaf text-lg px-8 py-4 font-bold fluorescent-glow transition-all duration-300 transform hover:scale-110">
                  Commencer gratuitement
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="cursor-leaf text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-green-600 font-bold transition-all duration-300 transform hover:scale-110">
                Demander une démo
              </Button>
            </div>
          </div>
