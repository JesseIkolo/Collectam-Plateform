        ...
        <div className="container mx-auto px-6 relative z-10 min-h-screen flex flex-col justify-center">
          <div className="text-center max-w-5xl mx-auto space-y-12">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
              <Link to="/signup">
                <Button size="lg" className="bg-green-600 hover:bg-green-700 text-lg px-12 py-4 rounded-2xl font-bold shadow-xl hover:shadow-2xl fluorescent-glow transition-all duration-300 transform hover:scale-110">
                  Je m'inscris
                </Button>
              </Link>
              <Button size="lg" variant="outline" className=" text-lg px-12 py-4 rounded-2xl border-2 border-white bg-white/90 hover:bg-white font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110">
                Télécharger l'app
              </Button>
              <Link to="/features">
                <Button size="lg" variant="ghost" className=" text-lg px-12 py-4 rounded-2xl text-white bg-white/20 hover:bg-white/30 font-bold backdrop-blur-sm border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110">
              ...
              <div className="bg-white/90 backdrop-blur-md rounded-3xl border border-white/30 p-6 shadow-2xl max-w-5xl mx-auto">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex space-x-6 overflow-x-auto">
                    ...
                    <div className="flex items-center space-x-2 px-4 py-2 hover:bg-blue-100 rounded-xl  transition-all min-w-max">
                    ...
                    <div className="flex items-center space-x-2 px-4 py-2 hover:bg-purple-100 rounded-xl  transition-all min-w-max">
                    ...
                    <div className="flex items-center space-x-2 px-4 py-2 hover:bg-orange-100 rounded-xl  transition-all min-w-max">
                      <BarChart3 className="w-4 h-4 text-orange-600" />
                      <span className="text-sm font-medium text-orange-800">Analyses</span>
                      <div className="text-xs bg-orange-200 px-2 py-1 rounded">Efficacité optimisée</div>
                    </div>
                    <div className="flex items-center space-x-2 px-4 py-2 hover:bg-red-100 rounded-xl  transition-all min-w-max">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-4 hover:bg-white/90 transition-all  shadow-lg hover:shadow-xl transform hover:scale-105">
              ...
              <p className="text-gray-600">Itinéraires intelligents pour une collecte efficace</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-4 hover:bg-white/90 transition-all  shadow-lg hover:shadow-xl transform hover:scale-105">
              ...
              <p className="text-gray-600">Visibilité complète sur toutes les opérations</p>
            </div>
      ...
      <section id="fonctionnalites" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Une suite complète d'outils intelligents pour révolutionner la collecte des déchets</p>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-6 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all ">
              ...
              <p className="text-gray-600">Signalez facilement les dépôts sauvages et planifiez vos collectes intelligemment</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-6 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all ">
              ...
              <p className="text-gray-600">Optimisez vos tournées et augmentez votre efficacité grâce à notre technologie</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-6 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all ">
              ...
              <p className="text-gray-600">Gérez vos flottes et équipes avec des outils intelligents professionnels</p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 text-center space-y-6 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all ">
              ...
              <p className="text-gray-600">Supervisez et coordonnez la propreté urbaine avec notre technologie avancée</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="comment" className="py-20 bg-gradient-to-br from-cyan-50 to-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">4 étapes simples pour une collecte optimisée</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-600">Inscription rapide et sécurisée en quelques clics avec vérification automatique</p>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-600">Signalez un dépôt sauvage ou planifiez une collecte avec géolocalisation précise</p>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-gray-600">Validation sur site avec QR Code et reconnaissance d'image automatique</p>
            </div>
            ...
            <div className="text-center space-y-6">
              ...
              <h3 className="text-xl font-bold text-gray-900">Suivi et analytics</h3>
              <p className="text-gray-600">Suivi en temps réel et analyses prédictives</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/signup">
                <Button size="lg" variant="secondary" className=" text-lg px-12 py-4 font-bold fluorescent-glow transition-all duration-300 transform hover:scale-110">
                  Je m'inscris maintenant
                </Button>
              </Link>
              <Button size="lg" variant="outline" className=" text-lg px-12 py-4 border-white text-white hover:bg-white hover:text-green-600 font-bold transition-all duration-300 transform hover:scale-110">
                Télécharger l'application
              </Button>
              <Link to="/contact">
                <Button size="lg" variant="ghost" className=" text-lg px-12 py-4 text-white hover:bg-white/10 font-bold transition-all duration-300 transform hover:scale-110">
                  Contactez-nous
                </Button>
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link to="/features" className=" hover:text-white transition-colors">Carte interactive</Link></li>
                <li><Link to="/features" className=" hover:text-white transition-colors">Missions automatiques</Link></li>
                <li><Link to="/features" className=" hover:text-white transition-colors">Signalement géolocalisé</Link></li>
                <li><Link to="/features" className=" hover:text-white transition-colors">Validation QR Code</Link></li>
              </ul>
            </div>
