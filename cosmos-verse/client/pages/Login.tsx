      ...
      <header className="fixed top-0 w-full bg-white/98 backdrop-blur-md border-b border-gray-200/50 z-50 shadow-sm">
        <div className="container mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/login">
              <Button className="h-10 px-6 text-sm font-medium bg-white border border-gray-300 text-[#212121]">Se connecter</Button>
            </Link>
            <Link to="/signup">
              <Button variant="outline" className="border-gray-300 h-10 px-6 text-sm font-medium">S'inscrire</Button>
            </Link>
          </div>
        </div>
      </header>

      {/* Login Form - Design System Uber Base */}
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl p-10 shadow-2xl border border-gray-100">
            ...
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl font-bold mb-3 tracking-tight">Connexion</h1>
              <p className="text-base tracking-wide">
                Accédez à votre compte Collectam
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input id="password" name="password" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleInputChange} placeholder="Votre mot de passe" className="h-12 pl-12 pr-12 border-2 focus:border-gray-600 rounded-xl text-base" required />
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-3">
                  <input type="checkbox" className="w-4 h-4 border-gray-300 rounded focus:ring-gray-500" />
            ...
            <div className="space-y-4">
              <Button variant="outline" className="w-full border-2 border-gray-300 hover:border-gray-400 py-4 text-base font-medium rounded-xl transition-all duration-200 h-12">
