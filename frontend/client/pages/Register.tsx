      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-collectam-100">Rejoignez la communauté Collectam</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                <input
                  ...
                  placeholder="Prénom"
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-collectam-200 focus:outline-none focus:ring-2 focus:ring-collectam-400 focus:border-transparent backdrop-blur-sm"
                />
              </div>
              <div className="relative">
                <input
            ...
            <div className="flex items-start">
              <input
                ...
                className="h-4 w-4 text-collectam-500 focus:ring-collectam-400 border-white/20 rounded bg-white/10 mt-1"
              />
              <span className="ml-2 text-sm text-collectam-100">
                J'accepte les{" "}
                <a href="#" className="text-collectam-300 hover:text-white transition-colors">
            ...
            <p className="text-center text-collectam-100">
              Déjà un compte ?{" "}
              <Link to="/login" className="text-collectam-300 hover:text-white font-semibold transition-colors">
                Se connecter
              </Link>
            </p>
